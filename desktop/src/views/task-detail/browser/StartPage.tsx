...
export function StartPage({ onGo, services }: Props) {
      ...
      <div className="flex h-full min-h-0 flex-col items-center justify-center gap-3 bg-background px-6 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Type a URL above to browse, or start a service in Runtime to open it here.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex h-full min-h-0 flex-col items-center justify-center overflow-auto bg-background px-6 py-12">
